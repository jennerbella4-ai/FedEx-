      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-5">
            ...
            <h5 className="text-lg text-gray-900">Get ready to reap rewards</h5>

            <p className="text-gray-600">
              Did you know FedEx has a loyalty program? With FedEx Rewards, you
              can earn gift cards from name-brand retailers when you ship. Get a
              $10 gift card with your first shipment after signup!
            </p>
          ...
          <div className="space-y-5">
            ...
            <p className="text-gray-600">
              ...
              confidence—and 50+ years of FedEx expertise backing you. Plus, the
              FedEx Import Tool makes paying fees simpler for your customers.
            </p>
          ...
          <div className="grid grid-cols-2 items-center">
            ...
            <div className="p-10 space-y-4">
              ...
              <p className="text-gray-600">
                ...
                packaging that fits the bill—and the budget. Get boxes, mailers,
                cushioning, and more to help protect your shipments.
              </p>
